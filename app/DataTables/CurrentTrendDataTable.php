...
class CurrentTrendDataTable extends DataTable
{
    /**
     ...
     */
    public function query(CurrentTrend $model): QueryBuilder
    {
    ...
    {
        return 'CurrentTrend_' . date('YmdHis');
    }
}
