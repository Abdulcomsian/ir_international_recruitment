...
use App\Models\QuebecClimateRecommendedActivity;
...
class QuebecClimateRecommendedActivitiesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function($row) {
                return view('quebec.climate.recommended-activities.action', ['row' => $row]);
            })
    ...
    {
        return $this->builder()
                    ->setTableId('QuebecClimateRecommendedActivity-table')
