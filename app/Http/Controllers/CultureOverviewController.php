...
class CultureOverviewController extends Controller
{
    public function index(CultureOverviewDataTable $dataTable, $id)
    {
        try{
            ...
            return redirect()->route('quebec.culture.quiz.overview.index')->with('error','Culture Quiz not found');
    ...
    public function store(Request $request, $quizId)
    {
        try{
            ...
            return redirect()->route('quebec.culture.quiz.overview.index', ['id' => $quiz->id])->with('error','Culture Quiz not found');
        }
    ...
    public function show($quizId)
    {
        try{
            ...
            return redirect()->route('quebec.culture.quiz.overview.index', ['id' => 'quizID'])->with('error','Culture Quiz not found');
        }
    ...
    public function edit($id)
    {
        try{
            ...
            return redirect()->route('quebec.culture.quiz.overview.index', ['id' => $id])->with('error','Culture Quiz not found');
    ...
    public function update(Request $request, $id)
    {
        try{
            ...
            return redirect()->route('culture.quiz.overview.index', ['id' => $cultureQuizid])
            ->with('success', 'Issue Occured!');
        }
