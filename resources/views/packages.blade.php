                        ...
                        <div class="row g-3">
                            <div class="col-xxl-12">
                                <div>
                                    ...
                                    <select readonly class="form-select planSelect" name="plan_type" aria-label="Default select example">
                                        <option selected="">Select your Status </option>
                                        @foreach ($plans as $plan)
                            ...
                            <div class="col-xxl-12">
                                <div>
                                    ...
                                    <input type="text"  readonly  name="plan_name" class="form-control" id="plan_name" placeholder="Enter Plan Name">
                                </div>
                            </div>
                            <div class="col-xxl-12">
                                <div>
                                    <label for="price" class="form-label">Discounted Price</label>
                                    <input type="text"  readonly  name="discounted_price" class="form-control" id="discounted_price" placeholder="Enter Price">
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-12">
                                <div>
                                    ...
                                    <input type="text"  readonly  name="recurring_price" class="form-control" id="recurring_price" placeholder="Enter Price">
                                </div>
                            </div>
