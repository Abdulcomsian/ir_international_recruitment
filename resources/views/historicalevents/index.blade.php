...
@section('content')
    <div class="container">
        <div class="card">
            <div class="card-header">Quebec Historical Events
            <button id="createNewService" class="btn btn-primary float-right">Create New Event</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createNewService').click(function() {
                ...
                window.location.href = '{{ route('quebec.historical.event.create') }}'; // Adjust the route as necessary
            });
        });
    </script>
<!-- 
