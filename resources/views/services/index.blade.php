...
@section('content')
    <div class="container">
        <div class="card">
            <div class="card-header">Manage Services
            <button id="createNewService" class="btn btn-primary float-right">Create New Service</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createNewService').click(function() {
                ...
                window.location.href = '{{ route('services.create') }}'; // Adjust the route as necessary
            });
        });
    </script>
<!-- 
