...
@section('content')
    <div class="container">
        <h1>Add Legal Aspect Quiz Question</h1>

        <form action="{{ route('quebec.legal-aspects.quiz.question.store', ['id' => $id, 'overview' => $overview]) }}" method="POST" enctype="multipart/form-data">
